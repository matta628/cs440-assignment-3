...
//        SharedPtr<Derived> sp3(sp2); // Should give a syntax error.
    ...
    printf("Modified Basic tests 1 passed.\n");
}
...
basic_tests_2() {
...

    {
        ...
        printf("Test construction from object.\n");
        {
            A *ap = new A;
            SharedPtr<A> a(ap);
            assert(a.get() == ap);
        ...
        printf("Test construction from another SharedPtr of the same type.\n");
        {
            SharedPtr<A> a(new A);
            SharedPtr<A> a2(a);
        }
        ...
        printf("Test construction from another SharedPtr of a derived type.\n");
        {
            SharedPtr<B> b(new B);
            SharedPtr<A> a(b);
        }
